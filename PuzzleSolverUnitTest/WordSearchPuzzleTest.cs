...
namespace PuzzleSolverUnitTest
{
    ...
    public class WordSearchPuzzleTest
    {
        ...
        [Test]
        public void Given4x4PuzzleWordWhenCallingGetUpLeftNeighborsStartingFromWith33By4ThenGetUpLeftNeighborsStartingFromReturnsAListOfVector2()
        {
            sut.AddLetterAt('K', 0, 0);
            sut.AddLetterAt('G', 1, 0);
            sut.AddLetterAt('J', 2, 0);
            ...
            Assert.IsInstanceOf(typeof(List<Vector2>), sut.GetUpLeftNeighborsStartingFrom(startPosition, 4));
        }

        [Test]
        public void Given4x4WordPuzzleWhenCallingGetUpLeftNeighborsStartingFromWith33By4ThenGetGetUpLeftNeighborsStartingFromReturnsAListOfVector2Startingfrom33()
        {
            sut.AddLetterAt('K', 0, 0);
            sut.AddLetterAt('G', 1, 0);
            sut.AddLetterAt('J', 2, 0);
            ...
            Vector2 startPosition = new Vector2(3, 3);
            List<Vector2> result = sut.GetUpLeftNeighborsStartingFrom(startPosition, 4);
            List<Vector2> expected = new List<Vector2>();
            expected.Add(new Vector2(3, 3));
            expected.Add(new Vector2(2, 2));
            expected.Add(new Vector2(1, 1));
